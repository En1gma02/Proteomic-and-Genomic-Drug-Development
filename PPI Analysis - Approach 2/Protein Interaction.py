...
def load_model():
    folder_huggingface_download = r'C:\Users\ppawa\Pranav\Study\Engineering\Hackathons\BioCode Breakers\Code Demos\PLM-Interact/'
...
with gr.Blocks(theme=YellowGreenTheme(), css=custom_css) as demo:
    gr.Markdown("# Protein-Protein Interaction Analysis")
